      ...
      <div class="hidden lg:flex flex-col justify-center p-10 space-y-6 text-red text-left" 
        ...
        <ul class="text-sm space-y-2 pt-2">
          <li class="flex items-start">
            <span class="text-yellow-400 mr-2 text-xl">✅</span> Mendapatkan Produk layanan terbaik.
          </li>
          <li class="flex items-start">
            <span class="text-yellow-400 mr-2 text-xl">⏱️</span> Akses langsung ke fitur simulasi dan hasil.
          </li>
          <li class="flex items-start">
            <span class="text-yellow-400 mr-2 text-xl">🔒</span> Data Anda aman dan terenkripsi.
          </li>
        </ul>
      </div>
